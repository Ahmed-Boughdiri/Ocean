...
route.post("/upload/thumbnail", upload, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, schemas_1.User.updateOne({
                        _id: userID
                    }, {
                        $set: {
                            thumbnail: ((_a = req.file) === null || _a === void 0 ? void 0 : _a.path) || "/uploads/unknown.png"
                        }
                    })];
            case 2:
                _b.sent();
                return [2 /*return*/, res.status(200).send("Done")];
            case 3:
                err_1 = _b.sent();
